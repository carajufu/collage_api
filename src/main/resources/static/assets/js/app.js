!function () {
    var d = document.querySelector(".navbar-menu").innerHTML, M = 7, t = "kr", a = localStorage.getItem("language");
    ...
    function n(e) {
        document.getElementById("header-lang-img") && (
                ...
                "it" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/italy.svg" :
                "ru" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/russia.svg" :
                "jp" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/jp.svg" :
                "vi" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/vi.svg" :
                "mn" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/mn.svg" :
                "ne" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/ne.svg" :
                "ch" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/china.svg" :
                "fr" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/french.svg" :
                "km" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/km.svg" :
                "la" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/la.svg" :
                "th" == e ? document.getElementById("header-lang-img").src = "/assets/images/flags/th.svg" :
                "ar" == e && (document.getElementById("header-lang-img").src = "/assets/images/flags/ae.svg"
            ),
            localStorage.setItem("language", e), null == (a = localStorage.getItem("language")) && n(t), (e = new XMLHttpRequest).open("GET", "/assets/lang/" + a + ".json"), e.onreadystatechange = function () {
            var a;

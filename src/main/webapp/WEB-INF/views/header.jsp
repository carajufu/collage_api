												...
												<div
													...
													<div class="d-flex">
														...
														<div class="flex-grow-1">
															...
															<p class="mb-0 fs-11 fw-medium text-uppercase text-muted">
																<span><i class="mdi mdi-clock-outline"></i> 48
																	min ago</span>
															</p>
														</div>
														<div class="px-2 fs-15">
							...
							<div class="dropdown ms-sm-3 header-item topbar-user ">
								...
								<div class="dropdown-menu dropdown-menu-end"
									...
									<a class="dropdown-item" href="pages-profile.html"><i
										...
										<span class="align-middle">개인 정보 수정</span></a> <a
										class="dropdown-item" href="apps-chat.html"><i
										class="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i>
										<span class="align-middle">메세지</span></a> <a class="dropdown-item"
									...
									<a class="dropdown-item" href="pages-profile-settings.html"><span
										...
										<span class="align-middle">설정</span></a> <a class="dropdown-item"
										href="auth-lockscreen-basic.html"><i
										class="mdi mdi-lock text-muted fs-16 align-middle me-1"></i> <span
										class="align-middle">화면 잠그기</span></a> <a class="dropdown-item"
										href="/logout"><i
						...
						<ul class="navbar-nav" id="navbar-nav">
								...
								<div class="collapse menu-dropdown" id="sidebarEnrollment">
									<ul class="nav nav-sm flex-column">
										<li class="nav-item"><a href="/enrollment/status"
											class="nav-link" data-key=""> 학적 관리 </a></li>
										<li class="nav-item"><a href="/enrollment/change"
											class="nav-link" data-key=""> 휴학/복학 신청 </a></li>
									</ul>
								</div></li>
								...
								<div class="collapse menu-dropdown" id="sidebargraduation">
									<ul class="nav nav-sm flex-column">
										<li class="nav-item"><a href="/stdnt/gradu/main/All"
											class="nav-link" data-key=""> 졸업 현황 </a></li>
									</ul>
								</div></li>
							...
							<li class="nav-item"><a class="nav-link menu-link"
								...
								aria-controls="sidebarLanding"> <i
									class="las la-certificate"></i> <span data-key="">제증명 발급</span>
							</a>
								<div class="collapse menu-dropdown" id="sidebarcertificate">
									<ul class="nav nav-sm flex-column">
										<li class="nav-item"><a href="landing.html"
											class="nav-link" data-key="">발급</a></li>
										<li class="nav-item"><a href="nft-landing.html"
											class="nav-link" data-key="">문서함</a></li>
									</ul>
								</div></li>
							...
							<li class="nav-item"><a class="nav-link menu-link"
								href="/dashboard/student" data-key=""> <i
									class="las la-university"></i> <span data-key="">학습 관리</span>
							</a></li>
					...
					<div class="container-fluid">
						...
						<ul class="navbar-nav" id="navbar-nav">
							...
							<li class="nav-item"><a class="nav-link menu-link"
								href="#sidebarLecture" data-bs-toggle="collapse" role="button"
								aria-expanded="false" aria-controls="sidebarDashboards"> <i
									class="las la-compass"></i> <span data-key="">강의</span>
							</a>
								<div class="collapse menu-dropdown" id="sidebarLecture">
									<ul class="nav nav-sm flex-column">
										<li class="nav-item"><a href="dashboard-analytics.html"
											class="nav-link" data-key=""> 나의 강의 </a></li>
										<li class="nav-item"><a href="dashboard-crm.html"
											class="nav-link" data-key="">강의 계획서 제출</a></li>
									</ul>
								</div></li>
							<!-- end Dashboard Menu -->
							<li class="nav-item"><a class="nav-link menu-link"
								...
								aria-expanded="false" aria-controls="sidebarDashboards"> <i
									class="las la-comments"></i> <span data-key="">상담</span>
							</a>
								<div class="collapse menu-dropdown" id="sidebarCounsel">
									<ul class="nav nav-sm flex-column">
										<li class="nav-item"><a href="dashboard-analytics.html"
											class="nav-link" data-key="">상담 요청</a></li>
										<li class="nav-item"><a href="dashboard-crm.html"
											class="nav-link" data-key="">상담 관리</a></li>
									</ul>
								</div></li>
							<!-- end Dashboard Menu -->
						</ul>

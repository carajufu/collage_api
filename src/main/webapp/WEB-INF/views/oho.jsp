                            ...
                            <div class="row align-items-end">
                                <div class="col-sm-8">
                                    <div class="p-3">
                                        ...
                                        <div class="mt-3">
                                            <a href="pages-pricing.html" class="btn btn-secondary">Upgrade Account!</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h4 class="mt-4 fs-22 ff-secondary fw-semibold"><span class="counter-value" data-target="28.05">0</span>k</h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h4 class="mt-4 fs-22 ff-secondary fw-semibold"><span class="counter-value" data-target="97.66">0</span>k</h4>
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h4 class="mt-4 fs-22 ff-secondary fw-semibold"><span class="counter-value" data-target="3">0</span>m
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <div>
                                    ...
                                    <h4 class="mt-4 fs-22 ff-secondary fw-semibold"><span class="counter-value" data-target="33.48">0</span>%</h4>
        ...
        <div class="row h-100">
            ...
            <div class="col-xl-6">
                <div class="card card-height-100">
                    ...
                    <div class="card-body p-0">
                        <div>
                            <div id="countries_charts" data-colors='["--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-secondary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary", "--vz-primary"]' class="apex-charts" dir="ltr"></div>
                        </div>
                    </div><!-- end card body -->
                </div><!-- end card -->
            </div> <!-- end col-->
...
<div class="row">
    ...
    <div class="col-xl-6">
        <div class="card card-height-100">
            ...
            <div class="card-body p-0">
                <div>
                    <div id="audiences-sessions-country-charts" data-colors='["--vz-secondary", "--vz-primary"]' class="apex-charts" dir="ltr"> </div>
                </div>
            </div><!-- end cardbody -->
        </div><!-- end card -->
    </div><!-- end col -->
            ...
            <div class="card-body">
                <div class="table-responsive table-card">
                    <table class="table align-middle table-borderless table-centered table-nowrap mb-0">
                        ...
                        <tr>
                            <td>
                                <a href="javascript:void(0);" class="text-reset">/themesbrand/skote-25867</a>
                            </td>
                            <td>99</td>
                            <td>25.3%</td>
                        </tr><!-- end -->
                        <tr>
                            <td>
                                <a href="javascript:void(0);" class="text-reset">/dashonic/chat-24518</a>
                            </td>
                            <td>86</td>
                            <td>22.7%</td>
                        </tr><!-- end -->
                        <tr>
                            <td>
                                <a href="javascript:void(0);" class="text-reset">/skote/timeline-27391</a>
                            </td>
                            <td>64</td>
                            <td>18.7%</td>
                        </tr><!-- end -->
                        <tr>
                            <td>
                                <a href="javascript:void(0);" class="text-reset">/themesbrand/minia-26441</a>
                            </td>
                            <td>53</td>
                            <td>14.2%</td>
                        </tr><!-- end -->
                        <tr>
                            <td>
                                <a href="javascript:void(0);" class="text-reset">/dashon/dashboard-29873</a>
                            </td>
                            <td>33</td>
                            <td>12.6%</td>
                        </tr><!-- end -->
                        <tr>
                            <td>
                                <a href="javascript:void(0);" class="text-reset">/doot/chats-29964</a>
                            </td>
                            <td>20</td>
                            <td>10.9%</td>
                        </tr><!-- end -->
                        <tr>
                            <td>
                                <a href="javascript:void(0);" class="text-reset">/steex/pages-29739</a>
                            </td>
                            <td>10</td>
                            <td>07.3%</td>
                        </tr><!-- end -->

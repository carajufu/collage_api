...
public class Stdnt_LectureEvlController {
    ...
    public String evalSubmit(@RequestBody Map<String, Object> body) {
        try {
            ...
            List<Integer> evlInnb = (List<Integer>) body.get("evlInnb");
            ...
            if (evlInnb == null || evlScore == null || evlInnb.size() != evlScore.size()) {
                log.error("강의평가 제출: evlInnb, evlScore 길이 불일치. evlInnb={}, evlScore={}", evlInnb, evlScore);
                return "fail_param";
            }

            log.info("강의평가 제출 시도 → estbllctreCode: {}, stdntNo: {}, evlInnb: {}, evlScore: {}, evlCn: {}",
                     estbllctreCode, stdntNo, evlInnb, evlScore, evlCn);

            lectureService.insertLectureEval(estbllctreCode, stdntNo, evlInnb, evlScore, evlCn);

...
public class Stdnt_LectureController {
    ...
    public String evalpage(@PathVariable String estbllctreCode, Model model) {
        ...
        // 강의 상세 (ALL_COURSE)
        LectureVO lectureVO = lectureService.getLectureByLctreCode(lctreCode);
...
//        model.addAttribute("evalItemList", evalItemList);
        ...
        return "lecture/stdntLctreDetail";
    }

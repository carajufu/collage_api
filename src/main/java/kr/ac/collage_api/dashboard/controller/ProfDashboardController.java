...
import kr.ac.collage_api.dashboard.service.ProfessorDashboardService;
...
public class ProfDashboardController {
	...
	public String professorDashboard(@RequestParam(value = "year", required = false) Integer year,
		...
		List<DashLectureVO> lectureList =
				professorDashboardService.selectProfessor(
						profsrNo,
		...
		log.debug("academicSchedules : " + academicSchedules);
		log.info(

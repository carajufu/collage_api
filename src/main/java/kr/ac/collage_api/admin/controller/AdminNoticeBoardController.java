...
public class AdminNoticeBoardController {
	...
	public Map<String, Object> getlist() {
		...
		List<BbsCttVO> bbsVOList = this.bbsNoticeService.adminList();
	...
	public int putdetail(@RequestPart BbsCttVO bbsVO,
	...
	public int postdetail(BbsCttVO bbsVO) {
		String acntId = "a001";
	...
	public Map<String, Object> adminDetail(@PathVariable int bbscttNo) {
		...
		BbsCttVO bbsVO = this.bbsNoticeService.adminDetail(bbscttNo);

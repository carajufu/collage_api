...
public class Prof_GradeController {
    ...
    public String profGradeMain(Model model) {
        List<GradeVO> allSbject = gradeService.getAllSbject(profsrNo);
        log.info("allSbject : {}", allSbject);
        model.addAttribute("allSbject",allSbject);
        return "grade/profGradeMain";
    }
    ...
    @ResponseBody
    public List<GradeVO> searchStudent(@RequestParam("keyword") String keyword, String estbllctreCode) {
    ...
    @ResponseBody
    public String updateGrade(@ModelAttribute GradeForm gradeForm) {
    ...
    @ResponseBody
    public String saveGrade(@ModelAttribute GradeForm gradeForm, @RequestParam("estbllctreCode") String estbllctreCode) {
    	log.info("gradeForm : {}", gradeForm.getGrades());
